...
## 1.1. Getting a Youtube Data API key
...
## 1.2. Providinng the API key to your application

### 1.2.1 Option 1 - Environment variable (recommended)
...
### 1.2.2 Option 2 - hardcode API key
